...
insert into Student value(0, 'S111','2020-04-11');
insert into Student value(1, 'S222','2019-04-12');
insert into Student value(2, 'S333','2018-04-09');
insert into Student value(3, 'S444','2018-04-10');
insert into Student value(4, 'S555','2017-04-21');
insert into Student value(5, 'S666','2017-04-21');
insert into Student value(6, 'S777','2017-04-21');
...
create table SC (
    ...
    Constraint PK_SC PRIMARY KEY (sno,cno,term),
...
insert into SC value(0, 7, 76, 7);
insert into SC value(0, 8, 80, 7);

#term 8
insert into SC value(1, 0, 58, 8);
insert into SC value(4, 9, 89, 8);
insert into SC value(2, 10, null, 8);
insert into SC value(3, 10, null, 8);


insert into SC value(5, 0, 90, 8);

insert into SC value(6, 1, 100, 8);